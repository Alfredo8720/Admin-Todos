...
import { removePrtoductFromCart } from '../../shopping-Cart/actions/actions';
...
export const ProductCard = ({id, name, price, rating, image}:Props) => {
  ...
  const onRemoveFromCart = () => {
    removePrtoductFromCart(id);
    router.refresh();
  }

  return (
    <div className="shadow rounded-lg max-w-sm bg-gray-800 border-gray-800">
